...
whose backend/env isn't available here -- run again on Sockeye for the rest.
    ...
    python scripts/ClaudeScripts/gas_reference_report.py
    python scripts/ClaudeScripts/gas_reference_report.py --models Orb-v2 CHGNet-0.3.0
    python scripts/ClaudeScripts/gas_reference_report.py --out runs/gas_refs_report.csv
"""
