...
columns instead of silently mislabeled O numbers.
    ...
    python scripts/studies/mo2/o_adsorption_benchmark.py runs/o_ads_benchmark
    python scripts/studies/mo2/o_adsorption_benchmark.py runs/co_ads_benchmark --adsorbate CO
