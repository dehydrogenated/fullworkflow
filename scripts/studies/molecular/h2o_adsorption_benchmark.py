...
IrO2(110) has no molecular minimum.
    ...
    python scripts/studies/molecular/h2o_adsorption_benchmark.py runs/h2o_ads_benchmark
    python scripts/studies/molecular/h2o_adsorption_benchmark.py runs/h2o_ads_benchmark --oxides RuO2 IrO2 --models UMA-omat
"""
