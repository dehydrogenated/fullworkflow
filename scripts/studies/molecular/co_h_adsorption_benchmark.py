...
UMA-M-* stays last since it's still the slowest.
    ...
    python scripts/studies/molecular/co_h_adsorption_benchmark.py runs/co_h_ads_benchmark
    python scripts/studies/molecular/co_h_adsorption_benchmark.py runs/co_h_ads_benchmark --oxides IrO2
"""
